...
const List<DailyAyah> _ayahs = [
  DailyAyah(
    ...
    ayahId: 17,
    surah: "Al-Qamar",
    arabic: "وَلَقَدۡ يَسَّرۡنَا ٱلۡقُرۡءَانَ لِلذِّكۡرِ فَهَلۡ مِن مُّدَّكِرٖ",
    translation:
  ...
  DailyAyah(
    ...
    ayahId: 114,
    surah: "Ta-Ha",
    arabic: "وَقُل رَّبِّ زِدۡنِي عِلۡمٗا",
  ...
  DailyAyah(
    ...
    ayahId: 286,
    surah: "Al-Baqarah",
    arabic: "لَا يُكَلِّفُ ٱللَّهُ نَفۡسًا إِلَّا وُسۡعَهَاۚ",
  ...
  DailyAyah(
    ...
    ayahId: 153,
    surah: "Al-Baqarah",
    arabic: "يَٰٓأَيُّهَا ٱلَّذِينَ ءَامَنُواْ ٱسۡتَعِينُواْ بِٱلصَّبۡرِ وَٱلصَّلَوٰةِۚ",
  ...
  DailyAyah(
    ...
    ayahId: 3,
    surah: "At-Talaq",
    arabic: "وَمَن يَتَوَكَّلۡ عَلَى ٱللَّهِ فَهُوَ حَسۡبُهُۥٓۚ",
  ...
  DailyAyah(
    ...
    ayahId: 60,
    surah: "Ghafir",
    arabic: "وَقَالَ رَبُّكُمُ ٱدۡعُونِيٓ أَسۡتَجِبۡ لَكُمۡۚ",
  ...
  DailyAyah(
    ...
    ayahId: 53,
    surah: "Az-Zumar",
    arabic: "لَا تَقۡنَطُواْ مِن رَّحۡمَةِ ٱللَّهِۚ",
  ...
  DailyAyah(
    ...
    ayahId: 128,
    surah: "An-Nahl",
    arabic: "إِنَّ ٱللَّهَ مَعَ ٱلَّذِينَ ٱتَّقَواْ وَّٱلَّذِينَ هُم مُّحۡسِنُونَ",
  ...
  DailyAyah(
    ...
    ayahId: 69,
    surah: "Al-'Ankabut",
    arabic: "وَٱلَّذِينَ جَٰهَدُواْ فِينَا لَنَهۡدِيَنَّهُمۡ سُبُلَنَاۚ",
  ...
  DailyAyah(
    ...
    ayahId: 7,
    surah: "Ibrahim",
    arabic: "لَئِن شَكَرۡتُمۡ لَأَزِيدَنَّكُمۡۖ",
  ...
  DailyAyah(
    ...
    ayahId: 3,
    surah: "Al-'Asr",
    arabic: "وَتَوَاصَوۡاْ بِٱلۡحَقِّ وَتَوَاصَوۡاْ بِٱلصَّبۡرِ",
  ...
  DailyAyah(
    ...
    ayahId: 159,
    surah: "Ali 'Imran",
    arabic: "فَإِذَا عَزَمۡتَ فَتَوَكَّلۡ عَلَى ٱللَّهِۚ",
  ...
  DailyAyah(
    ...
    ayahId: 56,
    surah: "Al-A'raf",
    arabic: "إِنَّ رَحۡمَتَ ٱللَّهِ قَرِيبٞ مِّنَ ٱلۡمُحۡسِنِينَ",
  ...
  DailyAyah(
    ...
    ayahId: 4,
    surah: "Al-Hadid",
    arabic: "وَهُوَ مَعَكُمۡ أَيۡنَ مَا كُنتُمۡۚ",
