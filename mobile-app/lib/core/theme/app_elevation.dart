...
class AppElevation {
  ...
  static List<BoxShadow> get shadowSm => [
    BoxShadow(color: _tint.withValues(alpha: 0.06), blurRadius: 6, offset: const Offset(0, 1)),
  ];

  static List<BoxShadow> get shadowMd => [
    BoxShadow(color: _tint.withValues(alpha: 0.08), blurRadius: 12, offset: const Offset(0, 4)),
  ];

  static List<BoxShadow> get shadowLg => [
    BoxShadow(color: _tint.withValues(alpha: 0.12), blurRadius: 24, offset: const Offset(0, 8)),
  ];

  /// The docked audio player's shadow casts upward, away from the bottom edge.
  static List<BoxShadow> get shadowPlayer => [
    BoxShadow(color: _tint.withValues(alpha: 0.10), blurRadius: 16, offset: const Offset(0, -4)),
  ];
  ...
  static List<BoxShadow> get shadowInsetHairline => [
    BoxShadow(color: _tint.withValues(alpha: 0.14), blurRadius: 0, spreadRadius: 0.5),
  ];
}
