...
export function BottomNav() {
  ...
  return (
    <motion.nav
      ...
      className={cn(
        "glass-panel fixed inset-x-0 bottom-4 z-40 mx-auto flex w-fit items-center gap-1 rounded-full !border-gold-leaf/15 px-2 py-2 shadow-lg md:hidden",
      ...
      {TABS.map(({ href, label, icon: Icon, match, authReason }) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "relative flex h-11 w-14 flex-col items-center justify-center gap-0.5 rounded-full",
